...
/* package */ final class PinkFlutterPageDelegate {
    ...
    @Nullable
    private PinkFlutterSplashView flutterSplashView;
    @Nullable
    ...
    PinkFlutterPageDelegate(@NonNull Host host) {
        this.host = host;
    }

    /**
     * Disconnects this {@code PinkFlutterPageDelegate} from its host {@code Activity} or
     * {@code Fragment}.
     *
     * <p>No further method invocations may occur on this {@code PinkFlutterPageDelegate}
    ...
    View onCreateView(
        ...
        flutterSplashView = new PinkFlutterSplashView(host.getContext());
    ...
    private void ensureAlive() {
        if (host == null) {
            throw new IllegalStateException(
                    "Cannot execute method on a destroyed PinkFlutterPageDelegate.");
        }
    }
