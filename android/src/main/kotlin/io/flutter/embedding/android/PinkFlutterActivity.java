...
public class PinkFlutterActivity extends Activity implements PinkFlutterPageDelegate.Host, LifecycleOwner {
    ...
    public static NewEngineIntentBuilder withNewEngine() {
        return new NewEngineIntentBuilder(PinkFlutterActivity.class);
    }
    ...
    public static class NewEngineIntentBuilder {
        private final Class<? extends PinkFlutterActivity> activityClass;
         ...
         */
        public NewEngineIntentBuilder(@NonNull Class<? extends PinkFlutterActivity> activityClass) {
    ...
    public static CachedEngineIntentBuilder withCachedEngine(@NonNull String cachedEngineId) {
        return new CachedEngineIntentBuilder(PinkFlutterActivity.class, cachedEngineId);
    }
    ...
    public static class CachedEngineIntentBuilder {
        ...
        public CachedEngineIntentBuilder(
                @NonNull Class<? extends PinkFlutterActivity> activityClass, @NonNull String engineId) {
            this.activityClass = activityClass;
    ...
    @VisibleForTesting
    /* package */ void setDelegate(@NonNull PinkFlutterPageDelegate delegate) {
